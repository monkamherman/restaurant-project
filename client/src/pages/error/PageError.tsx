...
const PageError: React.FC = () => {
	return (
		<section className='relative w-screen h-screen overflow-x-hidden bg-dark py-10'>
			<SEO
			...
			<div className='container relative z-40 flex items-center justify-between flex-col md:flex-row gap-6 md:gap-10 h-full w-full'>
				<div className="max-w-full lg:max-w-[50%] flex-1 w-full h-full py-0 flex items-center justify-center flex-col gap-6 md:gap-8 lg:gap-10">
					<div className="w-fit">
						<h1 className=' p-0 w-fit mx-auto text-5xl md:text-6xl lg:text-7xl text-center font-bold'>
							<span
						...
						<h2 className=" p-0 w-fit text-2xl md:text-3xl lg:text-5xl text-center font-semibold">
							Page Not Found
						</h2>
					</div>

					<p className=" p-0 w-fit text-center text-base md:text-lg text-foreground/80">
				...
				<div className="max-w-full lg:max-w-[50%] flex-1 w-full md:h-full flex items-center justify-center text-center">
					<img
						...
						className="w-full h-full pointer-events-none select-none text-white"
					/>
				</div>
			</div>
		</section>
